...
from justorservice.main import client  # noqa: E402


class WindowsService(win32serviceutil.ServiceFramework):
    _svc_name_ = os.getenv('SERVICE_NAME', 'ORSvc')
    _svc_display_name_ = os.getenv('SERVICE_DISPLAY_NAME', 'JustOR Service')
    _svc_description_ = os.getenv('SERVICE_DESCRIPTION', 'JustOR-Service Status')
